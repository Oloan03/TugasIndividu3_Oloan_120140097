...
export default class App extends Component {
  ...
  getImage = (image) => {
    switch (image) {
      case "garuda":
        return require("./assets/grd.png")
        break;
      case "lion":
        return require("./assets/ln.png")
        break;
      case "batik":
        return require("./assets/btk.png")
        break;
    }
  }
  ...
  render() {
    ...
    return (
      <ScrollView style={{ flex: 1 }}>
        ...
        {menu1 && (
          <>
            ...
            <View style={styles.footer}>
              <Text>&copy; 2023. Oloan Soaloon Napitupulu-120140097.</Text>
            </View>
          </>
        )}
        ...
        {isCari && (
          <Text style={styles.footer}>&copy; 2023  Oloan Soaloon Napitupulu-120140097.</Text>
        )}
